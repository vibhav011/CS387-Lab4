function get_batting_graph(db_client, request, response) { // request and response are parts of the http get method
    ...
    const query = 'select t1.match_id, coalesce(match_runs, 0) as match_runs from (select distinct match_id as match_id from ball_by_ball where striker = $1 or non_striker = $1) t1 \
